 ...
 */
#define weakify(...) ext_keywordify metamacro_foreach_cxt(ext_weakify_, , __weak, __VA_ARGS__)

/**
 * Like #weakify, but uses \c __unsafe_unretained instead, for targets or
 * classes that do not support weak references.
 */
#define unsafeify(...) ext_keywordify metamacro_foreach_cxt(ext_weakify_, , __unsafe_unretained, __VA_ARGS__)
 ...
 */
#define strongify(...)                                                                               \
    ext_keywordify _Pragma("clang diagnostic push") _Pragma("clang diagnostic ignored \"-Wshadow\"") \
    metamacro_foreach(ext_strongify_, , __VA_ARGS__) _Pragma("clang diagnostic pop")
...
#define ext_weakify_(INDEX, CONTEXT, VAR) CONTEXT __typeof__(VAR) metamacro_concat(VAR, _weak_) = (VAR);

#define ext_strongify_(INDEX, VAR) __strong __typeof__(VAR) VAR = metamacro_concat(VAR, _weak_);
